import pytest
from RePiCore.CheckingLayer.base import NotInRange
...
def test_init(name, checked_value, max_value, min_value, description, max_inclusive, max_exclusive):
    NotInRange(name, checked_value, max_value, min_value, description, max_inclusive, max_exclusive)
...
def test_init(name, checked_value, max_value, min_value, description, max_inclusive, max_exclusive):
    o = NotInRange(name, checked_value, max_value, min_value, description, max_inclusive, max_exclusive)
    o.check()